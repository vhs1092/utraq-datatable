...
我们以基本例子 [`examples/src/Basic/index.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/examples/src/Basic/index.vue) 为例，效果见 [examples#basic](https://OneWayTech.github.io/vue2-datatable/examples/dist#basic)
...
从 https://unpkg.com/utraq-datatable/dist 获取最新版本的资源，在页面中引入：
