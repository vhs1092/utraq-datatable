...
我们来看看 [`locale/zh-cn.js`](https://github.com/vhs1092/utraq-datatable/blob/master/locale/zh-cn.js) 包含什么内容：
...
本组件采用的是最简单的方案（见 [`src/main.js`](https://github.com/vhs1092/utraq-datatable/blob/master/src/main.js)）：
...
模板中是这样操作（以 [`src/PageSizeSelect.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/src/PageSizeSelect.vue) 为例）：
