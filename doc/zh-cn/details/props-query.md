...
让我们来看看本 Datatable 是如何初始化 `query` 的（源码见 [`src/index.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/src/index.vue) 中的 `created` 钩子函数）：
...
> （其中第 2 种见 [`examples/src/Advanced/comps/th-Filter.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/examples/src/Advanced/comps/th-Filter.vue) 中的 `methods.search`）  
> 
...
**都应该重置 `query.offset` 为 `0`**（参考 [`examples/src/Advanced/comps/th-Filter.vue - Line 39`](https://github.com/vhs1092/utraq-datatable/blob/master/examples/src/Advanced/comps/th-Filter.vue#L39)）  
**否则查询结果必然有误！**
