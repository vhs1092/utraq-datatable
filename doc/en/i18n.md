...
import locale from 'utraq-datatable/locale/zh-cn'

Vue.use(Datatable, { locale }) // done!
```

What's in the `locale`? Let's take a look at [`locale/zh-cn.js`](https://github.com/vhs1092/utraq-datatable/blob/master/locale/zh-cn.js):
...
Copy and paste from [`src/main.js`](https://github.com/vhs1092/utraq-datatable/blob/master/src/main.js):
...
Apply to [`src/PageSizeSelect.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/src/PageSizeSelect.vue):
