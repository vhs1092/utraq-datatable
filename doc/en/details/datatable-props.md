...
> Source: [`src/_mixins/props.js`](https://github.com/vhs1092/utraq-datatable/blob/master/src/_mixins/props.js)
...
> The advanced example (source: [`examples/src/Advanced/index.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/examples/src/Advanced/index.vue), demo: [examples#advanced](https://OneWayTech.github.io/vue2-datatable/examples/dist#advanced))  
