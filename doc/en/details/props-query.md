...
Let's see how this Datatable initializes `query` (source: `created` hook in [`src/index.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/src/index.vue)):
...
> (Method 2 can refer to `methods.search` in [`examples/src/Advanced/comps/th-Filter.vue`](https://github.com/vhs1092/utraq-datatable/blob/master/examples/src/Advanced/comps/th-Filter.vue))
> 
...
**Any changes to `query` should reset `query.offset` to `0` (e.g. [`examples/src/Advanced/comps/th-Filter.vue - Line 39`](https://github.com/vhs1092/utraq-datatable/blob/master/examples/src/Advanced/comps/th-Filter.vue#L39))**  
